    ...
    <Card>
      ...
      <CardContent className='grid gap-6'>
        <RadioGroup defaultValue='card' className='grid grid-cols-3 gap-4'>
          ...
          >
            <RadioGroupItem value='card' id='card' className='sr-only' aria-label='Card' />
            <svg
          ...
          <Label
            ...
            className='flex flex-col items-center justify-between rounded-md border-2 border-muted bg-transparent p-4 hover:bg-accent hover:text-accent-foreground [&:has([data-state=checked])]:border-primary'
          >
            <RadioGroupItem value='paypal' id='paypal' className='sr-only' aria-label='Paypal' />
          ...
          <Label
            ...
            className='flex flex-col items-center justify-between rounded-md border-2 border-muted bg-transparent p-4 hover:bg-accent hover:text-accent-foreground [&:has([data-state=checked])]:border-primary'
          >
            <RadioGroupItem value='apple' id='apple' className='sr-only' aria-label='Apple' />
